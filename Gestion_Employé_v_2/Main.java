        ...
        do {
            ...
            switch (choix) {
                case 1:
                    ...
                    if (poste.equalsIgnoreCase("Manager")) {
                        System.out.print("Entrez le nombre de personnes sous responsabilité : ");
                        int nombrePersonnes = scanner.nextInt();
                        employeeManager.ajouterEmploye(new Manager(id, nom, poste, salaire, nombrePersonnes));
                    } else if (poste.equalsIgnoreCase("Developer")) {
                        System.out.print("Entrez le langage de spécialisation : ");
                        scanner.nextLine(); // Consommer la nouvelle ligne
                        String langage = scanner.nextLine();
                        employeeManager.ajouterEmploye(new Developer(id, nom, poste, salaire, langage));
                    } else {
                ...
                case 2:
                    ...
                    employeeManager.supprimerEmploye(idSuppression);
                    break;

                case 3:
                    // Afficher tous les employés
                    employeeManager.afficherTousLesEmployes();
                    break;
                ...
                case 4:
                    ...
                    employeeManager.afficherEmployeParId(idAffichage);
                    break;
